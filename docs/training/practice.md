# Практические работы и учебные материалы

## 7 Практические работы
Практические работы закрепляют операции, рассмотренные на вебинарах.

| Код | Наименование | Задание | Критерий выполнения |
|---|---|---|---|
| ПР-01 | Обзор и навигация | Войти в учебную среду, найти основные функциональные области и открыть назначенный раздел | Пользователь самостоятельно находит требуемый раздел |
...
| ПР-03 | Работа с файлами и связями | Приложить учебный файл и установить связь с учебной записью | Файл доступен, связь открывает правильный объект |
...
- учебная среда, предоставленная организатором обучения;
- набор учебных заявок, документов, файлов и пространственных данных;
